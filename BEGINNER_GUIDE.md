...
The first thing you need to do is verify your Oculus developer account. To do that, go to this website and log in with your Meta Account: https://developer.oculus.com/

<p align="center">
 <img src="https://github.com/Shopify/handy/blob/main/readme_images/login.png" width="600"/>
</p>

Next click on your profile picture and then click on "Preferences".
...
Next go to this website to create an organization: https://developer.oculus.com/manage/organizations/create/
